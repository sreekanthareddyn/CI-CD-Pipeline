...
def ARTIFACT_DIR = "jenkins_biacm_build"
def NEXUS_REPO = 'http://34.214.232.47:8081/nexus/content/repositories/test/biacm'
...
echo 'moving dirs for biacm to jenkins directory'
cp -r ~/Reporting/BIACM ./${ARTIFACT_DIR}/Reporting

echo 'creating biacm tarball...'
tar -zcf ./${ARTIFACT_DIR}/${APPLICATION_NAME}-${ARTIFACT_VERSION}.${BUILD_NUMBER}.tar.gz ./${ARTIFACT_DIR}/Reporting/BIACM
echo 'created biacm build tarball'
					"""
					echo '-------------------------------------------------------------------------------------------------------'
