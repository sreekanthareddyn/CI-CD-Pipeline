...
echo 'moving dirs for otbi_bip to jenkins directory'
cp -r ./Reporting/OTBI_BIP ./${ARTIFACT_DIR}/Reporting
echo 'creating otbi_bip tarball...'
tar -zcf ./${ARTIFACT_DIR}/${APPLICATION_NAME}-${ARTIFACT_VERSION}.${BUILD_NUMBER}.tar.gz ./${ARTIFACT_DIR}/Reporting/OTBI_BIP
echo 'created otbi_bip build tarball'
					"""
					echo '-------------------------------------------------------------------------------------------------------'
