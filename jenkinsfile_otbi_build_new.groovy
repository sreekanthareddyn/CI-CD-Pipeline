...
def ARTIFACT_DIR= "jenkins_otbi_build"
def NEXUS_REPO = 'http://34.214.232.47:8081/nexus/content/repositories/test/otbi'
...
echo 'moving dirs for otbi to jenkins directory'
cp -r ./Reporting/OTBI ./${ARTIFACT_DIR}/Reporting
echo 'creating otbi tarball...'
tar -zcf ./${ARTIFACT_DIR}/${APPLICATION_NAME}-${ARTIFACT_VERSION}.${BUILD_NUMBER}.tar.gz ./${ARTIFACT_DIR}/Reporting/OTBI
echo 'created otbi build tarball'
					"""
					echo '-------------------------------------------------------------------------------------------------------'
