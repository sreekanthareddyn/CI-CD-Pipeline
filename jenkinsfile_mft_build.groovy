...
def ARTIFACT_DIR= "jenkins_mft_build"
def NEXUS_REPO = 'http://34.214.232.47:8081/nexus/content/repositories/test/mft'
...
echo 'moving dirs for mft to jenkins directory'
cp -r ./Integrations/MFT ./${ARTIFACT_DIR}/Integrations
echo 'creating mft tarball...'
tar -zcf ./${ARTIFACT_DIR}/${APPLICATION_NAME}-${ARTIFACT_VERSION}.${BUILD_NUMBER}.tar.gz ./${ARTIFACT_DIR}/Integrations/MFT
echo 'created mft build tarball'
					"""
					echo '-------------------------------------------------------------------------------------------------------'
